...
flags.DEFINE_float('boxsize2D',5.0,'field of view in degrees (default is optimal for default settings, use FindConfigs.ipynb notebook to find optimal fov for your setting.')
...
flags.DEFINE_spaceseplist('zs_source',['0.05'],'source redshifts')
...
flags.DEFINE_string('label', 'test_deriv', 'label of this run')
