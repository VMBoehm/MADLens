...
flags.DEFINE_float('boxsize',16.,'size of the simulation box in Mpc/h')
flags.DEFINE_integer('Nmesh',16,'resolution of fastPM mesh')
flags.DEFINE_integer('Nmesh2D',32, 'resolution of lensing map')
flags.DEFINE_float('boxsize2D',6.37616/2.,'field of view in degrees (default is optimal for default settings, use FindConfigs.ipynb notebook to find optimal fov for your setting.')
