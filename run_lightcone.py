...
flags.DEFINE_float('boxsize2D',9.668510876545103,'field of view in degrees (default is optimal for default settings, use FindConfigs.ipynb notebook to find optimal fov for your setting.')
...
flags.DEFINE_spaceseplist('zs_source',['1.5'],'source redshifts')
