...
flags.DEFINE_float('boxsize2D',11.129394568162963,'field of view in degrees (default is optimal for default settings, use FindConfigs.ipynb notebook to find optimal fov for your setting.')
