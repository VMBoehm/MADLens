...
flags.DEFINE_float('boxsize2D',15.101856624746889,'field of view in degrees (default is optimal for default settings, use FindConfigs.ipynb notebook to find optimal fov for your setting.')
...
flags.DEFINE_spaceseplist('zs_source',['0.8'],'source redshifts')
